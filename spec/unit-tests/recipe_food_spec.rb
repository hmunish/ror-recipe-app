...
RSpec.describe RecipeFood, type: :model do
  ...
  let(:recipe) do
    Recipe.create(name: 'rice', preparation_time: '1 hour', cooking_time: '30 minutes',
                  description: 'Lorem ipsum', public: false, user:)
  end
  let(:food) do
    Food.create(name: 'rice', measurement_unit: 'pieces', price: 75,
                quantity: 100, user:)
  end
